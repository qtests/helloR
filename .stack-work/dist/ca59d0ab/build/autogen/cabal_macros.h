...
/* package helloR-0.1.0.0 */
#define VERSION_helloR "0.1.0.0"
#define MIN_VERSION_helloR(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package inline-r-0.9.0.1 */
#define VERSION_inline_r "0.9.0.1"
...
#define CURRENT_COMPONENT_ID "helloR-0.1.0.0"

#define CURRENT_PACKAGE_KEY "helloR-0.1.0.0"
